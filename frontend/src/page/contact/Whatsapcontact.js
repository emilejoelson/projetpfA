...
const Whatsapcontact = ({ fullname, email, telephone, sujet, message, icon, loading }) => {
      ...
      {fullname ? (
        <Box width="100%" m="0 30px">
          ...
          <Box display="flex" justifyContent="space-between" mt="2px">
            ...
            >
              <Typography variant="h4" sx={{ color: 'white' }}>Sujet</Typography>
              <Box>{sujet}</Box>
            </Typography>
          </Box>
          <Box display="flex" justifyContent="space-between" mt="2px">
